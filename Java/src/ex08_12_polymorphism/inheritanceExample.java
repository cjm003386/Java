...
class inheritanceExample {
	public static void main(String args[]) {
		...
		System.out.println("예금주이름:" + obj1.ownerName);
		...
		System.out.println("예금주이름:" + obj2.ownerName);
		...
		System.out.println("예금주이름:" + obj3.ownerName);
		...
		System.out.println("예금주이름:" + obj4.ownerName);
