...
// 직불 계좌 클래스(CheckingAccount) - 서브클래스 (상속을 받는 클래스)
...
public class CheckingAccount extends Account {
	...
	/*
	 * 메서드 이름 : pay
	 * 매개변수 : 카드번호(cardNo-문자열), 인출액(amount-정수형)
	 * 반환형 : int
	 * 반환되는 값 : 부모 클래스의 인출메서드 호출
	 * 
	 * balance 필드와 withdraw() 메서드는 Account 클래스로 부터 상속 받아 사용 가능합니다.
